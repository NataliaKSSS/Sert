...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОбластьДействияХарактеристика.Видимость = Ложь;
	Элементы.ОбластьДействияСерия.Видимость          = Ложь;
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	КлючеваяОперация = "Чтение_СертификатыНоменклатуры";
...
Процедура НоменклатураНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка) 
	...
	ОткрытьФорму("Справочник.Товары.ФормаВыбора",ПараметрыФормы,ЭтаФорма);
КонецПроцедуры
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Если Элементы.ОбластьДействия.ТекущиеДанные <> Неопределено Тогда
		Элементы.ОбластьДействия.ТекущиеДанные.Номенклатура = ВыбранноеЗначение;
		ОбластьДействияНоменклатураПриИзменении(Неопределено);
	КонецЕсли;
	НоменклатураПриИзмененииСервер();
КонецПроцедуры 
...
&НаКлиенте
Процедура ОбластьДействияНоменклатураНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	ПараметрыФормы = Новый Структура("РежимВыбора",Истина);
...
Процедура ЗаполнитьОбластьДействия(СсылкаСертификатаНоменклатуры)
	...
	Если КоличествоЭлементовТаблицы = 1 Тогда
		...
		Иначе
			...
			ВидНоменклатуры = СтрокаОбластиДействия.ВидНоменклатуры;
			Номенклатура    = Справочники.Товары.ПустаяСсылка();
...
Процедура НоменклатураПриИзмененииСервер()
	...
	Если ЗначениеЗаполнено(Номенклатура) Тогда
		...
		ИменаРеквизитов       = "ВидНоменклатуры";
