...
&НаКлиенте
Асинх Процедура ВыполнитьПодключениеДрайвераСканераШтрихкодов(ДрайверСканераШтрихкодов = Неопределено)
...
// Параметры: 
Процедура НачатьОтключениеСканераШтрихкодов(ОповещениеЗавершение, ДрайверСканераШтрихкодов = Неопределено) Экспорт
	Если ДрайверСканераШтрихкодов <> Неопределено Тогда
...
&НаКлиенте
Асинх Процедура ВыполнитьОтключениеСканераШтрихкодов(ДрайверСканераШтрихкодов = Неопределено)
