...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя = "ПроектнаяРаботаOtus";
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия, 
	...
	КлючеваяОперация1.ИмяКлючевойОперации = "Чтение_СертификатыНоменклатуры";
	КлючеваяОперация1.ЦелевоеВремя = 1;	
	
	КлючеваяОперация2 = Новый Структура("ИмяКлючевойОперации, ЦелевоеВремя");
	КлючеваяОперация2.ИмяКлючевойОперации = "Чтение_СертификатыНоменклатуры_ПрисоединенныеФайлы";
